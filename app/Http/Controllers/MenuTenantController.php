...
class MenuTenantController extends Controller
{
    ...
    {
        $userTenant = UserTenant::where('user_id', $this->user->id)->first();
        ...
        $query = Menu::with(['category'])->where('tenant_id', $userTenant->tenant_id);
    ...
    {
        $data = $request->only('category_id', 'name', 'image', 'price', 'tax', 'is_percent_tax');
        ...
        try {
            ...
            $data['tenant_id'] = $userTenant->tenant_id;
    ...
    {
        $data = $request->only('category_id', 'name', 'image', 'price', 'tax', 'is_percent_tax', 'is_active');
